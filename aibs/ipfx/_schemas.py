...
class FeatureExtractionParameters(ArgSchema):
    ...
    sweep_list = Nested(FxSweepParameters, many=True)
...
class QcParameters(ArgSchema):
    ...
    sweep_data = Nested(QcSweepParameters, many=True, required=True)

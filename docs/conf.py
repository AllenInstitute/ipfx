...
# -*- coding: utf-8 -*-
#
# ipfx documentation build configuration file, created by
...
for d in os.path.join(cwd,sphinx_gallery_conf['examples_dirs']):
    print(os.listdir(d))
print("*********************")
print("*********************")
...
version = allensdk.ipfx.__version__
# The full version, including alpha/beta/rc tags.
release = allensdk.ipfx.__version__

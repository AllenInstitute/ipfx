.. toctree::
   ...
   auto_examples/index
   pipeline
   API Documentation <allensdk.ipfx>
   history
...
.. code-block:: python
    ...
    from allensdk.ipfx.ephys_extractor import SpikeTrainFeatureExtractor
...
.. code-block:: python
    ...
    from allensdk.ipfx.ephys_data_set import Sweep, SweepSet
...
.. code-block:: python
    ...
    from allensdk.ipfx.ephys_extractor import SpikeExtractor, SpikeTrainExtractor
    from allensdk.ipfx.stimulus_protocol_analysis import LongSquareAnalysis
...
``allensdk.ipfx`` also contains the scripts that deploy features of this library into the Allen Institute's production pipeline.  

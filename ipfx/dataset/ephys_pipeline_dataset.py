...
class _EphysPipelineDataset(abc.ABC):
    ...
    @abc.abstractmethod
    def __init__(self, data: EphysDataInterface):  # TODO: change -- the sweep info should not be argued here, rather it should be delegated to the data interface # NOQA: E501
        pass

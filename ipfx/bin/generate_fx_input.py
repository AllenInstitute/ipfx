...
extract_input_json = "sweep_extraction_input.json"
extract_output_json = "sweep_extraction_output.json"
qc_output_json = "qc_output.json"

input_json = "fx_input.json"
...
outdata= {
    ...
    'output_nwb_file': 'test_data/output.nwb',
    'qc_fig_dir': 'test_data/qc_figs',
    'sweep_list': sweeps,
